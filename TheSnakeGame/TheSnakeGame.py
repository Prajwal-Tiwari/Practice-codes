...
def TheSnakeGame():
    ...
    while con:
        ...
        if gs:
            ...
            if nh[0]<=0 or nh[0]>=500-l or nh[1]<=21 or nh[1]>500-b2:
                m2.play()
                con = False
                con2 = False
            if colod == (0,255,0):
            ...
            for j in range(0, 500, 20):
                p.draw.line(w, 'black', (0, j), (500, j), 1)
            for i in range(0, 500, 20):
                p.draw.line(w, 'black', (i, 20), (i, 500), 1)
            ...
            if ovr([nh[0], nh[1], l, b2], (a, b, 8)):
                m1.play()
                a = r.randrange(10, 500, 20)
                b = r.randrange(30, 500, 20)
                snakeHead.append(snakeHead[-1])
                point += 1
                sp += 1                                              #UN-COMMENT IT TO INCREASE DIFFICULTY
            clock.tick(60)
...
def gameMainScreen():
    ...
    sp = p.transform.scale(imp, (500,500))
    w.blit(sp,(0,0))
